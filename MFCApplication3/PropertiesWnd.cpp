...
void CPropertiesWnd::UpdatePropList(CString PathName,CString pProperty)
{
	SetPropListFont();
	...
	CMFCPropertyGridProperty* pProp = new CMFCPropertyGridProperty(_T("类型"), (_variant_t)_T(""), _T("指示该文件类型"));
	pProp->AllowEdit(FALSE);
	pGroup1->AddSubItem(pProp);
	pProp = new CMFCPropertyGridProperty(_T("路径"), (_variant_t)_T(""), _T("该文件的存放路径"));
	pGroup1->AddSubItem(pProp);
	pGroup1->AddSubItem(new CMFCPropertyGridProperty(_T("名称"), (_variant_t)_T(""), _T("该文件的名称")));

	pGroup1->AddSubItem(new CMFCPropertyGridProperty(_T("地址"), (_variant_t) 0l, _T("该文件写入ROM时的地址")));
	pGroup1->AddSubItem(new CMFCPropertyGridProperty(_T("附加说明"), (_variant_t)_T(""), _T("附加的说明，用于用户自己表明该文件的作用")));
